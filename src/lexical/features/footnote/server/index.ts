...
import { linkPopulationPromiseHOC } from './graphQLPopulationPromise'
import { i18n } from './i18n'
import { transformExtraFields } from './transformExtraFields'
import { linkValidation } from './validate'
import { createNode, createServerFeature, NodeWithHooks } from '@payloadcms/richtext-lexical'
import { convertLexicalNodesToHTML } from 'node_modules/@payloadcms/richtext-lexical/dist/features/converters/lexicalToHtml/sync/index.js'
...
>({
  feature: async ({ config: _config, isRoot, parentIsLocalized, props }) => {
    ...
    return {
      ClientFeature: '@/lexical/features/footnote/client',
      clientFeatureProps: {
        defaultLinkType,
        defaultLinkURL,
